...
def get_welcome_response():
    ...
    session_attributes = {}
    card_title = "Welcome"
    speech_output = "Welcome to the Trove Australia Alexa Application. " \
                    "Please ask me for a book by saying, " \
                    "Trove search book"
    # If the user either does not reply to the welcome message or says something
    # that is not understood, they will be prompted again with this text.
    reprompt_text = "Please ask me for a book by saying, " \
                    "Trove search book"
